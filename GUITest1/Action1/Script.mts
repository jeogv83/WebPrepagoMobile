...
Browser("Login").Page("Login").WebEdit("CL_Web_Personas_Layouts_wt8$bl").Set "956494674"
wait(1)
Browser("Login").Page("Login").WebEdit("CL_Web_Personas_Layouts_wt8$bl_2").Click
Browser("Login").Page("Login").WebEdit("CL_Web_Personas_Layouts_wt8$bl_2").Set "255963864"
wait(1)
Browser("Login").Page("Login").WebEdit("CL_Web_Personas_Layouts_wt8$bl_3").Click
Browser("Login").Page("Login").WebEdit("CL_Web_Personas_Layouts_wt8$bl_3").SetSecure "5ccc6de034cdce04c587c9c63922"
wait(1)
